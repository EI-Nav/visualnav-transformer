"""GNM navigation model server for NavArena evaluation."""
...
class GNMServer(NavigationModelServer):
    """NavArena-compatible server that runs GNM inference."""

    def __init__(self, inference: GNMInference, controller: PDController) -> None:
