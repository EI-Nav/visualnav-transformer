"""ViNT navigation model server for NavArena evaluation."""
...
class ViNTServer(NavigationModelServer):
    """NavArena-compatible server that runs ViNT inference."""

    def __init__(self, inference: ViNTInference, controller: PDController) -> None:
