...
def main(config):
    ...
    if "load_run" in config:
        load_project_folder = os.path.join("logs_test", config["load_run"])
...
if __name__ == "__main__":
    ...
    config["project_folder"] = os.path.join(
        "logs_test", config["project_name"], config["run_name"]
    )
    os.makedirs(
        config[
            "project_folder"
    ...
    if config["use_wandb"]:
        ...
        # Only set entity if specified in config, otherwise use default (user's own entity)
